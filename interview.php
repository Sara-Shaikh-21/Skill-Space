...
<!-- =======Interview Section ======= -->
    <section id="about">
      <div class="container wow fadeInUp">
        <div class="row">
          <div class="col-md-12">
            <h3 class="section-title"><br><br>Available Interview Questions</h3>
            <div class="section-title-divider"></div>
            <p class="section-description">Our interview questions have been are mostly asked questions for interview. The end result are battle-tested interview questions that can be used during the hiring process.</p>
        ...
        <div class="gallery" style=" width: 500px; position: relative; margin-left:450px;" >
  <a target="_self" href="#question" >
    <img src="assets/img/interview_logo.JPG" class="center" alt="hiring Guide" style=" 
                                            margin-left:150px; background-color:#e8f1ff; ">
  </a>
            <div class="desc"><a href="#question"><strong>View Interview Questions</strong></a></div>
    <p style="font-size:15px; text-align: center"><i>Stop spending hours trawling the internet for interview questions.View Our interview question's guide. </i></p>
</div>
...
<section id="question">
     <img src="assets/img/design.JPG" alt="" style="width:100%;">
...
<div id="questions-navbar">
        ...
        <a href="#get">Graduate Engineer Trainee</a>
        <a href="#get">Diploma Engineer Trainee</a>
 ...
 <br><br>
    ...
    <div class="que-row">
  <div class="column">
    <div class="card" style="margin-left: 67px;">
...
<?php include ('include/footer.php');?>
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center" style="margin-right: -20;">
