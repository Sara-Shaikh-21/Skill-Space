...
<section id="contact">
    ...
    <h3 class="section-title"> <br>Trainee Master </h3><br>
...
<form action="excel2.php" method="post">
	<center><button type="submit" name="export_excel" placeholder="Export to Excel" class="btn btn-danger">Download Excel sheet</button></center>
        </form></div>
</section>
