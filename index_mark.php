...
<body>
  <div class="container" style="margin-top: 30px; margin-bottom: 60px;">
    ...
    <h3 class="section-title"> <br>TRAININGS ALLOTED TO YOU<br><br>MARK THE ATTENDANCE ACCORDINGLY</h3><br>
...
//           here i get the id of hod from sessions
            ...
            $sql="SELECT trainings.empid,training_code.train_id, trainings.title, trainings.date,
            trainings.duration,trainings.time,training_code.train_name,indi_training.date 
            FROM trainings,training_code,indi_training
            WHERE trainings.empid='$id' and
...
//            print_r($employees);
            ...
            <td><?php echo $test['time']; ?></td>
                ...
                <td><a href="mark_attendence.php?id=<?php echo $test['train_id'] ?>&train=<?php echo $test['train_name']?>"><span class="glyphicon glyphicon-check" ></span></td>
